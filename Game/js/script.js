...
let sound_point = new Audio("https://github.com/afiyataibani/JavaScript/blob/master/Game/sound/point.mp3");
let sound_die = new Audio("https://github.com/afiyataibani/JavaScript/blob/master/Game/sound/die.mp3");
...
function play() {
  ...
  let pipe_creation_interval = setInterval(() => {
    if (game_state == "Play") {
      create_pipe();
    } else {
